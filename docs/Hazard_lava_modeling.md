...
!!! tip "Lava flows"
    ...
    Lava flows are typically **non-newtonian**, **pseudoplastic** fluids with with a **yield strength**.
...
As already discussed, the combination of all these parameters make **lava flow modeling** associated with **large uncertainties**. One critical aspect of risk management is that these lava flow crises are often **long-lasting** crises, and predicting the spatio-temporal evolution is currently largely impossible beyond a time window of a few hours to days. This is especially true for **pāhoehoe flow fields**.
...
1. The understanding the **limitations** of each models and their **sources of uncertainties**;
