...
**Tephra deposits** are therefore widespread deposits generated by explosive volcanic eruption. Here, we will explore **what** is tephra, **why** are tephra deposits important and how they can **impact** populations and assets around volcanoes. Later in the module, we will learn how to **model** the transportation and deposition of tephra after eruptions, and how to **quantify** their associated hazards. 
...
In the field, tephra deposits generally appear as unconsolidated *pyroclastic* material that are able to blanket the existing topography, and their thicknesses exponentially decrease with distance from the source vent. 
...
=== "Vulcano"
    ...
    <figcaption>Figure 3: Deposit associated with the 1888-1890 eruption of La Fossa volcano, Italy. This section represents years of unsustained, pulsatory activity (Picture: S. Biass).</figcaption>
    </figure>
...
Tephra deposits are **a direct reflection of the eruptive conditions** occurring in the plume. By **studying**, **mapping** and **characterizing** them, we can therefore infer important **eruption source parameters** (ESP) for a given eruption. This is critical for two aspects:

1. For a given eruption, this helps us constrain the eruption type (&rarr; magnitude, intensity, duration, style).
2. Repeating that a volcanic system, this provides a tool for **revisiting** the stratigraphy and constrain its **eruptive behaviour** which, in turn, helps constraining what type of eruption scenarios could happen in the future.
...
| **Fragility function**             | Mathematical function expressing the probability of a level of impact being equalled or exceeded for a given hazard intensity[^8]. See Figure 8 for an example of fragility functions defined for composite European roofs[^9].                                                                                                                                      |
...
<figcaption>Figure 8: Example of fragility functions describing the probability of collapse for weak (WE), medium weak (MW), medium strong (MS) and strong (ST) roofs as a function of the tephra load.</figcaption>
</figure>
...
The [2015 edition of the Global assessment report](https://www.undrr.org/publication/global-assessment-report-disaster-risk-reduction-2015) (GAR) on disaster risk reduction report by the United Nations Office for Disaster Risk Reduction was the first one to consider the volcanic risk. This testifies of the growing awareness of the potential large-scale to global impact of future large eruptions on modern societies. Similarly, re-insurance companies are [beginning to include volcanic risk](https://www.preventionweb.net/publication/destructive-power-volcanic-ash-fall-quantifying-volcanic-risks-will-improve) in their portfolios and developing new dedicated products through, for instance, parametric risk transfer solutions[^10] and [CAT bonds](https://catbond.org/about/). 

However, the complexity of the hazard associated with tephra fallout and the **full range of potential** impacts is often under-appreciated. The *Global Volcanic Hazards and Risk* book, [published in 2015](https://www.cambridge.org/core/books/global-volcanic-hazards-and-risk/7653B9CA75E2F32A81CE5B7110BEF8AB) in the context of the GAR report, contains a chapter entitled **Volcanic ash fall hazard and risk** by Jenkins et al.[^6]. This chapter is [freely accessible](https://www.cambridge.org/core/books/global-volcanic-hazards-and-risk/volcanic-ash-fall-hazard-and-risk/21EAC484CBDF5E5CB6F8E36D640BD2C3) online and offers a review of the impacts and proposes tentative damage/disruption states for key vulnerability aspects. Specifically:
...
We encourage you to get familiar with these values for the hazard and impact exercises in the lab and in the field!

## :material-check-bold:{ .icn } Summary

This introduction has introduced *what* are tephra deposits and *why* they matter, both from a perspective of **reconstructing** the **eruptive history** of volcanic systems and of their **associated impacts**. In the next sections, we will introduce how we can [model](Hazard_tephra_modeling.md) tephra deposit and assess their associated [hazards](Hazard_probabilistic2.md).
